...
class SignscoreAction extends Action {

    //显示
    public function index(){
		C('HTTP_CACHE_CONTROL','no-store, no-cache, must-revalidate');
        ...
        //木有领卡 ,跳到领卡页面。
        /*if(empty($get_card)){
            Header("Location: "."http://".C('site_url').'/'.U('Wap/Card/vip',array('token'=>$this->_get('token'),'wecha_id'=>$this->_get('wecha_id')))); 
            exit('领卡后才可以签到.');
        }*/
